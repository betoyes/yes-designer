...
Este plugin **Yes Carrossel-v1** roda em DUAS plataformas. Toda alteração (editor, SKILL.md,
...
2. **OpenAI Codex** (CLI / IDE / app) — mesmo padrão de skills (agentskills.io).
   ...
   - Uso local: copiar `plugins/carrossel-pro/skills/carrossel-pro/` para `~/.codex/skills/yes-carrossel-v1/`.
...
5. Regera os deliverables Codex (zips) se for distribuir fora do GitHub:
   - `yes-carrossel-v1-codex-skill.zip`  (pasta da skill p/ ~/.codex/skills)
   - `yes-carrossel-v1-codex-plugin.zip` (plugin completo c/ .codex-plugin)
