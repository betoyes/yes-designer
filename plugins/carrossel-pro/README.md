...
- **Habilidade `yes-carrossel-v1`** — o playbook que o Claude carrega sozinho quando voce pede um carrossel. Ele descobre a marca, propoe o sistema visual (tipografia, paleta, voz), escreve a copy slide a slide e gera um `slides.json`.
